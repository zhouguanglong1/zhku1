...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/tribune.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/3.css" />
<link href="${pageContext.request.contextPath}/css/register.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/css/common.css"
	rel="stylesheet" type="text/css" />
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquery/jquery-1.11.2.js"></script>
...
<script type="text/javascript">
	...
	function checkUserName(){
		var username = $("#username").val();
		$("#span1").load("${pageContext.request.contextPath}/user/checkUserName.action?"+new Date().getTime(),{'username':username});
	}
...
<body>
	<!--头部-->
	<header class="zhku-nav "> <nav class="navber w"> <a
		href="#" class="f_l" title="zhkw" target="_blank"> <img
		src="${pageContext.request.contextPath}/images/logo1.png" alt="" />
	</a>
	<div class="n-sign f_l">
		<ul class="">
			...
			<li><a
				href="${pageContext.request.contextPath}/zhku/sys/zhkuStyle.jsp">
					仲园风采 </a></li>
			<li><a href="<%=path%>/category/categoryList.action?page=1">
					仲园咸鱼 </a></li>
			<li><a
				href="${pageContext.request.contextPath}/zhku/sys/board.jsp"> 论坛
			</a></li>
			<!-- <li>
                    <a href="#">仲园咸鱼</a>
                </li> -->
	...
	<div class="n-search f_r">
		<div class="input f_l">
			...
			<input type="text" name="srchtxt" value="请输入搜索内容" class=" xg1"
				placeholder="请输入搜索内容">
			<button type="submit" name="searchsubmit" class="pn pnc" value="true">
		...
		<c:if test="${sessionScope.username == null }">
			<div class="text f_l" id="login">
				<a href="${pageContext.request.contextPath}/zhku/login.jsp">登录</a> <span></span>
		...
		<c:if test="${ sessionScope.username != null}">
			<div id="username">
				<tr>
					<td><font color="white">欢迎您，</font> <span></span> <font
						color="red">${sessionScope.username}</font></td> &nbsp;
					<td><a
						href="${pageContext.request.contextPath}/zhku/modify.jsp"><font
							color="white">修改</font></a></td> &nbsp;
					<td><a
						href="${pageContext.request.contextPath}/user/quit.action"><font
							color="white">退出</font></a></td>
				</tr>
			</div>
		</c:if>
					...
					<form id="registerForm" enctype="multipart/form-data"
						...
						<table>
							<tbody>
								...
								<tr>
									<th>专业:</th>
									<td><input type="text" name="major" class="text"
										maxlength="20" value="${user.major}"></td>
								</tr>

								<tr>
									<th>班级:</th>
									<td><input type="text" name="className" class="text"
										maxlength="20" value="${user.className}"></td>
								</tr>

								<tr>
									<th>头像:</th>
									<td><c:if test="${user.photoPath !=null}">
											<img src="/photo/${user.photoPath}" width=100 height=100 />
											<br />
										</c:if> <input type="file" id="photo" name="photo"></td>
								</tr>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											class="captchaImage" src="<%=path%>/user/CheckImg.action"
											title="点击更换验证码" onclick="change()" /><span id="spanCode"></span>
									</span></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
