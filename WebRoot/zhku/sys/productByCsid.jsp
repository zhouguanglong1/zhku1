...
<div class="container productList">
	...
	<div class="pagination">
		第  ${pageBean2.page }/${pageBean2.totalPage }页
			...
			<a href = "${pageContext.request.contextPath}/product/findByCsid.action?csid=${categorySecondId }&page=1" >首页</a>
    	<c:choose>
    		<c:when test="${pageBean2.page gt 1 }">
    			<a href = "${pageContext.request.contextPath}/product/findByCsid.action?csid=${categorySecondId }&page=${pageBean2.page -1} " >上一页</a> 
    		</c:when>
    		<c:otherwise>
    			&nbsp;
    		</c:otherwise>
    	...
    	<c:choose>
    		<c:when test="${pageBean2.totalPage gt 1 && pageBean2.page ne pageBean2.totalPage}">
    			<a href = "${pageContext.request.contextPath}/product/findByCsid.action?csid=${categorySecondId }&page=${pageBean2.page +1} " >下一页</a>
    		</c:when>
    		<c:otherwise>
    			&nbsp;
    		</c:otherwise>
		...
		<a href = "${pageContext.request.contextPath}/product/findByCsid.action?csid=${categorySecondId }&page=${pageBean2.totalPage }">尾页</a> 
