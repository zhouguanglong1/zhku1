...
<html>
  ...
  <body>
    <form action="${pageContext.request.contextPath}/category/modifyCategory.action" method="post">
  ...
  <script>
    $(function () {       
		$('#backid').click(function(){
				window.location.href="${pageContext.request.contextPath}/category/adminCategoryList.action";
		 });
