...
<html>
  ...
  <body>
    <form action="${ pageContext.request.contextPath }/zone/addOrSaveZone.action" method="post">
	<table class="table table-bordered table-hover definewidth m10">
	
    <tr>
        <td width="10%" class="tableleft">版块名</td>
        <td><input type="text" name="name" value="${zone.name}"/></td>
        <td><input type="hidden" id="id" name="zid" value="${zone.id }"/></td>
    </tr>
  ...
  <script>
    $(function () {       
		$('#backid').click(function(){
				window.location.href="${pageContext.request.contextPath}/zone/adminZoneList.action";
		 });
