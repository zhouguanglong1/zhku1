...
<form class="form-inline definewidth m20" action="${pageContext.request.contextPath}/section/querySection.action" method="get">  
 ...
 版面描述:     
    ...
    <button type="submit" class="btn btn-primary">查询</button>&nbsp;&nbsp; <button type="button" class="btn btn-success" id="addnew">新增版面</button>
</form>
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <c:forEach items="${pageBean.list }" var="section">
	     <tr>
            <td>${section.id }</td>
...
<script>
    $(function () {
		...
		$('#addnew').click(function(){
				...
				window.location.href="${pageContext.request.contextPath}/zhku/forum/addSection.jsp";
		 });
