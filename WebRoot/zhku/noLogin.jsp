...
<table width="850px" border="0" cellspacing="0">
  <tr>
    <td style="padding:30px; text-align:center"><table width="60%" border="0" cellspacing="0" style="margin-top:30px">
      <tr>
        <td><img src="${pageContext.request.contextPath}/images/fail.png" width="80" height="80" /></td>
        <td style="padding-top:30px"><font style="font-weight:bold; color:#FF0000" size="5">对不起，您还没登录，请先登录！</font><br />
            <br />
          ...
          <a href="${ pageContext.request.contextPath }/user/login.action"><font size="5">登录</font></a>&nbsp;&nbsp;
           <br /><br />
           <font size="5">还没有账号？点击</font><a href="${ pageContext.request.contextPath }/user/regist.action"><font size="5" color="red">注册</font></a>
         </td>
      </tr>
