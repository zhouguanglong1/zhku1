							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" onblur="checkUserName()" value="${user.username}" /><span
										id="span1">
									</span></td>
								</tr>
								<tr>
									...
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off" value="${user.password}"/> <span id="span2">
									</span> </td>
								</tr>
								<tr>
									...
									<td><input type="password" id="repassword"
										...
										autocomplete="off" value="${user.password}"/> <span id="span3">
									</span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>E-mail:</th>
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200" value="${user.email}"/> <span id="span4">
									</span> </td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="className" class="text"
										maxlength="20" value="${user.className}">
									</td>
								</tr>
